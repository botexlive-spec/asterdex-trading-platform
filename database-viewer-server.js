 ...
 * Run: node database-viewer-server.js
 * Then open: http://localhost:3306 in your browser
 */
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div id="overview" class="section active">
                ...
                <h3 style="margin: 30px 0 20px 0;">Quick Access</h3>
            ...
            <div id="tables" class="section">
                ...
                <h2 style="margin-bottom: 20px;">Database Tables</h2>
    ...
    <script>
            ...
            try {
                ...
                const statsHTML = \`
                    ...
                    <div class="stat-card">
                        ...
                        <div class="value">$\${data.investment.toLocaleString()}</div>
                    </div>
                    <div class="stat-card">
                        <h3>TOTAL EARNINGS</h3>
                        <div class="value">$\${data.earnings.toLocaleString()}</div>
                    </div>
                    <div class="stat-card">
            ...
            try {
                ...
                if (data.length === 0) {
                    document.getElementById('table-details').innerHTML = \`
                        <div class="success">Table "\${tableName}" is empty</div>
                    \`;
                    return;
                }
                ...
                let html = \`
                    <h3>\${tableName} (\${data.length} rows)</h3>
        ...
        async function executeQuery() {
            ...
            try {
                ...
                if (data.length === 0) {
                    document.getElementById('query-results').innerHTML = \`
                        <div class="success">Query executed successfully (0 rows returned)</div>
                    \`;
                    return;
                }
...
app.listen(PORT, () => {
  ...
  console.log(`✓ Database: finaster_mlm`);
