-- ============================================================================
-- SEED DATA - Initial test data with admin and user accounts
-- ============================================================================
...
INSERT INTO packages (name, min_investment, max_investment, daily_roi_percentage, duration_days, level_income_percentages, matching_bonus_percentage, is_active) VALUES
  (
    ...
    5.00,
    40,
    '[10, 5, 3, 2, 1, 1, 1, 1, 1, 1, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]'::jsonb,
    10.00,
    true
  ),
  (
...
INSERT INTO users (
  ...
  'admin@finaster.com',
  '$2b$10$.xkAAqeCn.4na.x/G6NFAOEY10vOz0gM80Y/JLyhhLGYo7aqDFcoi', -- admin123
...
INSERT INTO users (
  ...
  'user@finaster.com',
  '$2b$10$BhLYDRj5ZZYwUapxDMu4aOehJYhADiPVQLrEiqjXVFC2tfC3Whh4G', -- user123
  'John Doe',
  'user',
  '00000000-0000-0000-0000-000000000001',
  'JOHNDOE001',
...
BEGIN
  FOR i IN 1..10 LOOP
    ...
    INSERT INTO users (
      ...
      user_uuid,
      'downline' || i || '@finaster.com',
      '$2b$10$BhLYDRj5ZZYwUapxDMu4aOehJYhADiPVQLrEiqjXVFC2tfC3Whh4G', -- user123
      'Downline User ' || i,
      'user',
      '4a6ee960-ddf0-4daf-a029-e2e5a13d8f87',
      'DOWNLINE' || LPAD(i::TEXT, 3, '0'),
      0,
      0,
      1000.00,
      'bronze',
